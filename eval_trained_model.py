...
PATH_TO_CKPT = 'trained-inference-graphs/output_inference_graph_v1/frozen_inference_graph.pb'#os.path.join(CWD_PATH,MODEL_NAME,'frozen_inference_graph.pb')

# Path to label map file
PATH_TO_LABELS = 'annotations/label_map.pbtxt'#os.path.join(CWD_PATH,'training','labelmap.pbtxt')
